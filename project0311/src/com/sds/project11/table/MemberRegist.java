...
public class MemberRegist extends JFrame {
	...
	MyTableModel model = new MyTableModel(); // JTable 이 보여줄 데이터에 대한 정보를 제공하는 자
	JTable table;
	JScrollPane scroll;
	...
	public void regist() {
		/*
		 * 배열은 처음에 생성 시 그 크기를 정해놓으면, 수정이 불가하다 따라서 기존의 data 변수가 가리키고 있던 배열은 버리고 새로운 배열을
		 * 생성하여 data에 대입해보자
		 */

		/*
		 * ArrayList에 새로운 맴버 추가하기
		 */
		String[] member = {
					t_id.getText(),
					t_phone.getText(),
